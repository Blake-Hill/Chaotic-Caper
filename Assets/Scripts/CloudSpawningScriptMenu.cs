...
//THIS SCRIPT SPAWNS CLOUDS ON THE MAIN MENU AT RANDOM Y INTERVALS AND RANDOM SCALE
...
public class CloudSpawningScriptMenu : MonoBehaviour
{
   ...
   //variables for cloud spawning logic
    ...
    void Start()
    {
        //set the cloud move speed to the menu move speed
        cloud.GetComponent<CloudMovingScript>().moveSpeed = menuMoveSpeed;

        //spawn cloud on start
        spawnCloud();  
    }
